...
export const mobileNavIconSizes: {
    InnerIconSize: string;
    ActionIconSize: MantineNumberSize;
    ActionIconLocalSVGSize: MantineNumberSize;

} = { InnerIconSize: "1.75rem", ActionIconSize: "sm", ActionIconLocalSVGSize: 45 }
...
export const tabletNavIconSizes: {
    InnerIconSize: string;
    ActionIconSize: MantineNumberSize;
    ActionIconLocalSVGSize: MantineNumberSize;

} = { InnerIconSize: "2rem", ActionIconSize: "lg", ActionIconLocalSVGSize: 55 }
...
export const desktopNavIconSizes: {
    InnerIconSize: string;
    ActionIconSize: MantineNumberSize;
    ActionIconLocalSVGSize: MantineNumberSize;

} = { InnerIconSize: "2.5rem", ActionIconSize: "xl", ActionIconLocalSVGSize: 60 }
