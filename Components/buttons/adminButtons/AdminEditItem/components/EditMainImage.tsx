import { AspectRatio, Card, Center, Group, Loader, LoadingOverlay, Text, Transition, useMantineColorScheme, useMantineTheme } from "@mantine/core";
        ...
        <Center>
            ...
            >
                ...
                <Card.Section>
                    ...
                    <LoadingOverlay radius={"md"} visible={mainImageEditLoadingValue} overlayBlur={5} zIndex={2} loader={<Loader color="pink" size="xl" />} />
